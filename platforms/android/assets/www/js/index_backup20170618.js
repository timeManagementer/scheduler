...
app.initialize();
    ...
    function displayDate() {        
        ...
        if(document.getElementById("getDateBtn").innerHTML == "Start"){
            ...
            addData(chart,"a",10);//add data to chart
        }
        //end押した時
    ...
    var day1 = new Date(theYear,theMonth,theDay,13,40,0,0);
    var dayStart = day1.getTime();
    var day2 = new Date(theYear,theMonth,theDay,13,45,59,999);
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [d1-dayStart,d2-d1,dayEnd-d2],
        }]
    },
